...
# Desc : This script is running from a CCE VM instance of type Debian 10 buster.
...
#
# create the apache config file for our django project
# 

echo "Writing to codebase config directory: $CONFDIR/$PRJNAME.conf .........."
echo
...
# srwx------  1 www-data          root        0 Apr  7 09:43 dflow_wsgi.85546.0.2.sock
...
#
sudo a2ensite $PRJNAME.conf          # enable our new site
